...
if ($failedServices.Count -eq 0) {
    ...
    Write-Host "   1. Verifica que Docker Desktop esté ejecutándose" -ForegroundColor White
    Write-Host "   2. Revisa los Dockerfiles en cada directorio" -ForegroundColor White
    Write-Host "   3. Verifica conexión a internet para el push" -ForegroundColor White
